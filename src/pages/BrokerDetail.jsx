  ...
  return (
    <div style={{ padding: '24px 15px', maxWidth: '600px', margin: 'auto', paddingBottom: '100px' }}>
      ...
      {assets.map((asset, index) => (
        <div key={index} style={{ backgroundColor: 'white', padding: '15px', borderRadius: '18px', border: '1px solid #eee', marginBottom: '10px' }}>
      ...
      <button onClick={handleAddAsset} style={{ width: '100%', padding: '15px', marginTop: '10px', borderRadius: '15px', border: '1px dashed #ccc' }}>+ Agregar Especie</button>
